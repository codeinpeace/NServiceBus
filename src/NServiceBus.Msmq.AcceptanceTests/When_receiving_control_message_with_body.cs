namespace NServiceBus.AcceptanceTests
{
    ...
    public class When_receiving_control_message_with_body : NServiceBusAcceptanceTest
    {
        ...
        class V33ControlMessageSimulator : Feature
        {
            ...
            {
                context.Container.ConfigureComponent<V33ControlMessageSimulatorTask>(DependencyLifecycle.SingleInstance);
                context.RegisterStartupTask(b => b.Build<V33ControlMessageSimulatorTask>());
            }
